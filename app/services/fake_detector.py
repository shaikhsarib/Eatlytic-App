...
# ==========================================
def detect_fake_claims(full_ocr_text: str, ingredients_raw: str) -> dict:
    """
    Checks if the front of the pack claims "No Sugar" but the back contains hidden sugars.
    """
    if not full_ocr_text or not ingredients_raw:
    ...
    hidden_sugars = [
        ...
        'corn syrup', 'invert sugar', 'date syrup', 'cane juice',
        'jaggery', 'honey'
    ]
...
# ==========================================
def apply_dna_overrides(full_ocr_text: str, nutrients: dict, ingredients_raw: str, base_score: int) -> dict:
    """
    ...
    lie_check = detect_fake_claims(full_ocr_text, ingredients_raw)
